...
public class IsSomethingExpr extends Expr<Boolean> {
    public static final String PATTERN = "^(?<expr1>.+) is( any(thing|one)?| something|(n't| not) (nothing|none|null|nil))$";
    private @UnknownNullability Expr<Object> expr1;

    public IsSomethingExpr() {
        super(Boolean.class);
    }
    ...
    public @NotNull Boolean eval(CodeContext context) throws ScriptException {
        ...
        return !IsNothingExpr.isNothing(eval);
    }
}
