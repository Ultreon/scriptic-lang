...
public class IsFiniteExpr extends Expr {
    @Override
    ...
    public CExpr compile(int lineNr, String code) throws CompileException {
        ...
        return new CExpr(this, code, lineNr) {
            ...
            public CValue<?> calc(CodeContext context) throws ScriptException {
                ...
                var valA = eval1.get();
                return new CValue<>(valA instanceof Double aDouble && Double.isFinite(aDouble) || valA instanceof Float aFloat && Float.isFinite(aFloat));
            }
