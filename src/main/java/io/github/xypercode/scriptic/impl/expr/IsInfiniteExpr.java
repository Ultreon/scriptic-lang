...
public class IsInfiniteExpr extends Expr {
    @Override
    public Pattern getPattern() {
        return Pattern.compile("^(?<expr1>.+) is infinite$");
    }
    ...
    public CExpr compile(int lineNr, String code) throws CompileException {
        ...
        return new CExpr(this, code, lineNr) {
            ...
            public CValue<?> calc(CodeBlock codeBlock, CodeContext context) throws ScriptException {
                ...
                var valA = eval1.get();
                return new CValue<>(valA instanceof Double aDouble && Double.isInfinite(aDouble) || valA instanceof Float aFloat && Float.isInfinite(aFloat));
            }
